                                    ...
                                    <li class="has-dropdown" data-tooltip="tooltip" data-placement="left" title="Account">
                                        ...
                                        <ul style="width:120px">
                                            <li>
                                                ...
                                                <a href="views/dashboard.php"><i class="fas fa-user-circle u-s-m-r-6"></i>
                            ...
                            <div class="ah-lg-mode">
                                ...
                                <ul class="ah-list ah-list--design2 ah-list--link-color-secondary">
                                    <li>
                                        ...
                                        <a href="shop-side-version-2.php">NEW ARRIVALS</a></li>
                                    <li class="has-dropdown">
                                        ...
                                        <ul style="width:170px">
                                            ...
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:200px">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="views/lost-password.php">Lost Password</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">

                                                <a href="views/dashboard.php">Dashboard<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                ...
                                                <ul style="width:200px">
                                                    <li class="has-dropdown has-dropdown--ul-left-100">
                                                        ...
                                                        <a href="views/dashboard.php">Manage My Account<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                        ...
                                                        <ul style="width:180px">
                                                            <li>
                                                                ...
                                                                <a href="views/dash-edit-profile.php">Edit Profile</a></li>
                                                            <li>

                                                                <a href="views/dash-address-book.php">Edit Address Book</a></li>
                                                            <li>

                                                                <a href="views/dash-manage-order.php">Manage Order</a></li>
                                                        </ul>
                                                        <!--====== End - Dropdown ======-->
                                                    </li>
                                                    <li>

                                                        <a href="views/dash-my-profile.php">My Profile</a></li>
                                                    <li class="has-dropdown has-dropdown--ul-left-100">

                                                        <a href="views/dash-address-book.php">Address Book<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                        ...
                                                        <ul style="width:180px">
                                                            <li>
                                                                ...
                                                                <a href="views/dash-address-make-default.php">Address Make Default</a></li>
                                                            <li>

                                                                <a href="views/dash-address-add.php">Add New Address</a></li>
                                                            <li>

                                                                <a href="views/dash-address-edit.php">Edit Address Book</a></li>
                                                        </ul>
                                                        <!--====== End - Dropdown ======-->
                                                    </li>
                                                    <li>

                                                        <a href="views/dash-track-order.php">Track Order</a></li>
                                                    <li>

                                                        <a href="views/dash-my-order.php">My Orders</a></li>
                                                    <li>

                                                        <a href="views/dash-payment-option.php">My Payment Options</a></li>
                                                    <li>

                                                        <a href="views/dash-cancellation.php">My Returns & Cancellations</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:200px">
                                                    <li>
                                                        ...
                                                        <a href="views/empty-search.php">Empty Search</a></li>
                                                    <li>

                                                        <a href="views/empty-cart.php">Empty Cart</a></li>
                                                    <li>

                                                        <a href="views/empty-wishlist.php">Empty Wishlist</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:200px">
                                                    <li>
                                                        ...
                                                        <a href="views/product-detail.php">Product Details</a></li>
                                                    <li>

                                                        <a href="views/product-detail-variable.php">Product Details Variable</a></li>
                                                    <li>

                                                        <a href="views/product-detail-affiliate.php">Product Details Affiliate</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                            ...
                                            <li>
                                                ...
                                                <a href="views/cart.php">Cart</a></li>
                                            <li>

                                                <a href="wishlist.php">Wishlist</a></li>
                                            <li>

                                                <a href="views/checkout.php">Checkout</a></li>
                                            <li>

                                                <a href="views/faq.php">FAQ</a></li>
                                            <li>

                                                <a href="views/about.php">About us</a></li>
                                            <li>

                                                <a href="views/contact.php">Contact</a></li>
                                            <li>
                                    ...
                                    <li class="has-dropdown">
                                        ...
                                        <ul style="width:200px">
                                            <li>
                                                ...
                                                <a href="views/blog-left-sidebar.php">Blog Left Sidebar</a></li>
                                            <li>

                                                <a href="views/blog-right-sidebar.php">Blog Right Sidebar</a></li>
                                            <li>

                                                <a href="views/blog-sidebar-none.php">Blog Sidebar None</a></li>
                                            <li>

                                                <a href="views/blog-masonry.php">Blog Masonry</a></li>
                                            <li>

                                                <a href="views/blog-detail.php">Blog Details</a></li>
                                        </ul>
                                        <!--====== End - Dropdown ======-->
                                    </li>
                                    <li>

                                        <a href="shop-side-version-2.php">VALUE OF THE DAY</a></li>
                                    <li>

                                        <a href="shop-side-version-2.php">GIFT CARDS</a></li>
                                </ul>
                                <!--====== End - List ======-->
                            </div>
                            <!--====== End - Menu ======-->
                                        ...
                                        <div class="mini-cart">
                                                ...
                                                <div class="card-mini-product">
                                                    <div class="mini-product">
                                                        <div class="mini-product__image-wrapper">
                                                            ...
                                                            <a class="mini-product__link" href="views/product-detail.php">
                                                        ...
                                                        <div class="mini-product__info-wrapper">
                                                            ...
                                                            <span class="mini-product__name">
                                                                ...
                                                                <a href="views/product-detail.php">Yellow Wireless Headphone</a></span>
                                                    ...
                                                    <div class="mini-product">
                                                        ...
                                                        <div class="mini-product__info-wrapper">
                                                            ...
                                                            <span class="mini-product__name">
                                                                ...
                                                                <a href="views/product-detail.php">Nikon DSLR Camera 4k</a></span>
                                                    ...
                                                    <div class="mini-product">
                                                        ...
                                                        <div class="mini-product__info-wrapper">
                                                            ...
                                                            <span class="mini-product__name">
                                                                ...
                                                                <a href="views/product-detail.php">New Dress D Nice Elegant</a></span>
                                                    ...
                                                    <div class="mini-product">
                                                        ...
                                                        <div class="mini-product__info-wrapper">
                                                            ...
                                                            <span class="mini-product__name">
                                                                ...
                                                                <a href="views/product-detail.php">New Fashion D Nice Elegant</a></span>
                                            ...
                                            <div class="mini-product-stat">
                                                ...
                                                <div class="mini-action">
                                                    ...
                                                    <a class="mini-link btn--e-brand-b-2" href="views/checkout.php">PROCEED TO CHECKOUT</a>

                                                    <a class="mini-link btn--e-transparent-secondary-b-2" href="views/cart.php">VIEW CART</a></div>
                                            </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <div class="product-m">
                                                <div class="product-m__thumb">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="views/product-detail.php">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">New Fashion B Nice Elegant</a></div>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">New Dress A Nice Elegant</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">New Dress B Nice Elegant</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">New Dress C Nice Elegant</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">New Fashion E Nice Elegant</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">New Fashion F Nice Elegant</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">Red Wireless Headphone</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">Yellow Wireless Headphone</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">Hover Skateboard Scooter</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">Hover Red Skateboard Scooter</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">Canon DSLR Camera 4k</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__name">
                                                        ...
                                                        <a href="views/product-detail.php">Nikon DSLR Camera 4k</a></div>
                                                    <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                        ...
                                        <div class="outer-footer__list-wrap">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="views/dashboard.php">Account</a></li>
                                                <li>

                                                    <a href="shop-side-version-2.php">Manufacturer</a></li>
                                                <li>

                                                    <a href="views/dash-payment-option.php">Finance</a></li>
                                                <li>
                                        ...
                                        <div class="outer-footer__list-wrap">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="views/contact.php">Contact Us</a></li>
                                                <li>

                                                    <a href="index.html">Sitemap</a></li>
                                                <li>

                                                    <a href="views/dash-my-order.php">Delivery</a></li>
                                                <li>
                                    ...
                                    <div class="u-s-m-b-15">
                                        <div class="pd-detail__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                                            ...
                                            <span class="pd-detail__review u-s-m-l-4">
                                                ...
                                                <a href="views/product-detail.php">23 Reviews</a></span></div>
                                    </div>
                                    <div class="u-s-m-b-15">
                                        <div class="pd-detail__inline">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="s-option">
                                    ...
                                    <div class="s-option__link-box">
                                        ...
                                        <a class="s-option__link btn--e-white-brand-shadow" href="views/cart.php">VIEW CART</a>

                                        <a class="s-option__link btn--e-brand-shadow" href="views/checkout.php">PROCEED TO CHECKOUT</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
