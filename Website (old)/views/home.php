...
<body class="config">
    ...
    <div id="app">
        ...
        <div class="app-content">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <a class="i3-banner" href="/shop-side-version-2">
                                        <div class="aspect aspect--bg-grey-fb aspect--square">

                                            <img class="aspect__img i3-banner__img" src="images/banners/i3-banner-1.jpg"
                                                alt="">
                                        </div>
                                    </a>
                                </div>
            ...
            <div class="u-s-p-b-60">
                ...
                <div class="section__content">
                    <div class="container">
                        <div class="row">
                            <?php
                            //TODO: creare foreach per iterare cards
                            $product = "test"; //rimuovere quando $product e home_card.php sono implementati
                            include "assets/home_card.php"; // Usa la variabile $product
                            ?>
                        </div>
                    </div>
                </div>
            ...
            <!--====== Section 6 ======-->
            <div class="u-s-p-b-60"> <!-- TODO: componentificare le cards seguenti
