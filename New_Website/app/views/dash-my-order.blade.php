                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                                        <div class="dash__pad-2">
                                            <h1 class="dash__h1 u-s-m-b-14">I miei Ordini</h1>

                                            <span class="dash__text u-s-m-b-30">Qui è possibile vedere tutti i prodotti che sono stati ordinati.</span>
                                            <div class="m-order__list">
                                                @foreach($data["orderList"] as $order)
                                                    @component("modules.account-card-order",$order)@endcomponent
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
