    ...
    <div class="outer-footer">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="outer-footer__content u-s-m-b-40">
                                ...
                                <span class="outer-footer__content-title">Our Store</span>
                                <div class="outer-footer__list-wrap">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a href="<?= ROOT?>Wishlist">Wishlist</a>
                                        </li>
                                        <li>
                ...
                <div class="col-lg-4 col-md-6"> <!-- information -->
                    <div class="row">
                        
                        <div class="col-lg-6 col-md-6">
                            <div class="outer-footer__content u-s-m-b-40"> <!-- account -->
                                <div class="outer-footer__list-wrap">
                            ...
                            <div class="outer-footer__content u-s-m-b-40">
                                <div class="outer-footer__list-wrap">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?= ROOT?>DashboardLogin">Admin Dashboard</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="lower-footer__content">
                        <div class="lower-footer__copyright">
                            ...
                            <a href="<?= ROOT?>">Li Paparuni shop</a>
