<header class="header--style-1 header--box-shadow">
    ...
    <!--====== Nav 1 ======-->
    <nav class="primary-nav primary-nav-wrapper--border navbar-image-custom-container">
            ...
            <div class="secondary-nav">
                ...
                <div class="menu-init enrico-trova" id="navigation2">
                    ...
                    <div class="ah-lg-mode">
                        ...
                        <span class="ah-close">✕ Chiudi</span>

                        <!--====== List ======-->
                        <ul class="ah-list ah-list--design2 ah-list--link-color-secondary">
                            <li>

                            <a href="<?= ROOT ?>products?category=&search=&casaEditrice=&orderBy=DataPubblicazione">NUOVI ARRIVI</a></li>
                            <li>

                                <a href="<?= ROOT ?>products">Prodotti</a></li>
                            <li>
                ...
                <div class="menu-init" id="navigation3">
                    ...
                    <button class="btn btn--icon toggle-button fas fa-shopping-cart toggle-button-shop" type="button"></button>
                    ...
                    <div class="ah-lg-mode">
                        ...
                        <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                            <li>
                                ...
                                <a href="<?=ROOT ?>"><i class="fas fa-home"></i></a></li>
                            <li>
                                ...
                                <div class="menu-init" id="navigation">
                                    ...
                                    <div class="ah-lg-mode">
                                        ...
                                        <!--====== List ======-->
                                        <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                                            <li class="has-dropdown" data-tooltip="tooltip" data-placement="left" title="{{getGreeting()}}">
                                                ...
                                                <ul style="width:120px">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="<?=ROOT?>account"><i class="fas fa-user-circle u-s-m-r-6"></i>
