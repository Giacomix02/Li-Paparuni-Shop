            ...
            <nav class="primary-nav primary-nav-wrapper--border">
                <div class="container">
                    ...
                    <div class="primary-nav">
                        ...
                        <a class="main-logo" href="index.blade.php">
                                                ...
                                                <div class="mega-menu-list">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="index.blade.php"><i class="fas fa-utensils u-s-m-r-6"></i>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="index.blade.php"><i class="fas fa-couch u-s-m-r-6"></i>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="index.blade.php"><i class="fas fa-football-ball u-s-m-r-6"></i>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="index.blade.php"><i class="fas fa-heartbeat u-s-m-r-6"></i>
                                            ...
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:118px">
                                                    <li>
                                                        ...
                                                        <a href="index.blade.php">Home 1</a></li>
                                                    <li>
                            ...
                            <div class="ah-lg-mode">
                                ...
                                <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                                    <li>
                                        ...
                                        <a href="index.blade.php"><i class="fas fa-home"></i></a></li>
                                    <li>
                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    <li class="has-separator">
                                        ...
                                        <a href="index.blade.php">Home</a></li>
                                    <li class="is-marked">
                                ...
                                <div class="about">
                                    <div class="about__container">
                                        <div class="about__info">
                                            ...
                                            <a class="about__link btn--e-secondary" href="index.blade.php" target="_blank">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="outer-footer__list-wrap">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="index.blade.php">Sitemap</a></li>
                                                <li>
                        ...
                        <div class="col-lg-12">
                            <div class="lower-footer__content">
                                <div class="lower-footer__copyright">
                                    ...
                                    <a href="index.blade.php">Reshop</a>
